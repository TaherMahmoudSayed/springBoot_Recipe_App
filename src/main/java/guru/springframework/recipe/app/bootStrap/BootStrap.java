...
import guru.springframework.recipe.app.domain.*;
...
public class BootStrap implements ApplicationListener<ContextRefreshedEvent>  {
    ...
    private List<Recipe> getRecipe(){
        ...
        /*
         *  get UnitofMeasure from db
         *  get category fom db
         *  create recipe
         *  create note
         *  add note to recipe and vice versa
         *  add recipe ingredients
         *  add recipe category         *
         * */

        UnitOfMeasure eachUom       = unitOfMeasureRepository.findByUom("Each").orElseThrow(() ->  new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findByUom("Tablespoon").orElseThrow(() ->  new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure teaSpoonUom   = unitOfMeasureRepository.findByUom("Teaspoon").orElseThrow(() ->  new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure dashUom       = unitOfMeasureRepository.findByUom("Dash").orElseThrow(() ->  new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure pintUom       = unitOfMeasureRepository.findByUom("Pint").orElseThrow(() ->  new RuntimeException("Expected UOM Not Found"));
        UnitOfMeasure cupsUom       = unitOfMeasureRepository.findByUom("Cup").orElseThrow(() ->  new RuntimeException("Expected UOM Not Found"));
        ...
        tacoNote.setDescription("We have a family motto and it is this: Everything goes better in a tortilla.\n" +
